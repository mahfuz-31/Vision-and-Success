...
\textvtt{We believe that, the words of All\=ah are complete and true from the view of information, just from the view of rules \& regulations and completely beautiful from the view of elequency. All\=ah says,
}
\begin{center}
    \begin{RLtext}
...
\textvtt{
We believe that, Qur'\=an is the Word of All\=ah. Truely He spoke it to Jibril and Jibril may the peace of All\=ah be upon him brought it (by the permision of All\=ah) tothe heart of Prophet Muhammad may the peace and blessings of All\=ah be on him. All\=ah says,
}
\begin{center}
    \begin{RLtext}
...
We believe that, All\=ah is above all the creation by His ownself and attributes. Like All\=ah says,
}
\begin{center}
    \begin{RLtext}
